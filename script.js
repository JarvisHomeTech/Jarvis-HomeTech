document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadProductLists() {
        ...
        try {
            ...
            // კალათაში დამატების ერთიანი ლოგიკა
    ...
    async function loadProductDetails() {
        ...
        try {
            ...
            if (product) {
                ...
                // <<<<<<<<<<<<<<< აქ იწყება მსგავსი პროდუქტების ლოგიკა >>>>>>>>>>>>>>>
                renderRelatedProducts(productId, products);
                // <<<<<<<<<<<<<<< აქ მთავრდება მსგავსი პროდუქტების ლოგიკა >>>>>>>>>>>>>>>
    ...
    // ===== მსგავსი პროდუქტების ფუნქცია (გამოიძახება ზემოთ) =====
    function renderRelatedProducts(currentProductId, allProducts) {
        ...
        new Swiper(".related-products-swiper", {
            ...
            breakpoints: {
                ...
                820: { slidesPerView: 4, spaceBetween: 20 },
            },
        });
    }
